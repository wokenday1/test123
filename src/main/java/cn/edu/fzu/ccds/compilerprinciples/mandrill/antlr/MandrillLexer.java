...
public class MandrillLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMENT", "WS", "DIGIT", "NONDIGIT", "If", "Else", "While", "Read", 
			"Put", "Write", "Get", "Func", "Break", "Continue", "Return", "Global", 
			"Local", "Comma", "LeftParen", "RightParen", "LeftBracket", "RightBracket", 
			"LeftBrace", "RightBrace", "Plus", "Minus", "Star", "Slash", "Semicolon", 
			"SingleQuota", "Assign", "Equality", "Inequality", "LargeThan", "LessThan", 
			"NoLessThan", "NoMoreThan", "Percentage", "IntegerConstant", "Identifier", 
			"StringConstant", "Schar", "CharacterConstant", "CChar", "EscapeSequence", 
	...
	public MandrillLexer(CharStream input) {
		super(input);
